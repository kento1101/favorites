...
$('#tab1_button').on('click', function () {
    console.log('tab1');
    if ($("#tab1_button").hasClass("tab-active")) {} else {
...
$('#tab2_button').on('click', function () {
    console.log('tab2');
    if ($("#tab2_button").hasClass("tab-active")) {} else {
...
$('#tab3_button').on('click', function () {
    console.log('tab3');
    if ($("#tab3_button").hasClass("tab-active")) {} else {
...
$('#tab4_button').on('click', function () {
    console.log('tab4');
    if ($("#tab4_button").hasClass("tab-active")) {} else {
...
$('#tab5_button').on('click', function () {
    console.log('tab5');
    if ($("#tab5_button").hasClass("tab-active")) {} else {
